...
using CheckIt.Infrastructure.Identity.Services;
using CheckIt.Infrastructure.Shared.Services;
...
namespace CheckIt.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"{0}\CheckIt.Api.xml", AppDomain.CurrentDomain.BaseDirectory));
